...
SAFETY_HARD_KEYWORDS = frozenset({
    ...
    # ── 系统级危险 ──
    "关机", "shutdown",
    # ── 暴力 / 武器 / 爆炸(白用户对网站能力误用, 直接拦截, 不交给模型) ──
    "制作炸弹", "炸弹", "炸药", "制造枪支", "枪支制造", "火药",
    # ── 色情 / 成人(与网站生成能力无关, 直接拦截, 避免模型内容审查裸抛 error) ──
    "色情", "色情网站", "成人网站", "裸聊", "性虐", "性爱视频", "约炮",
})
...
_BUILD_KW = ("网站", "官网", "站点", "建站", "生成网站", "页面", "网页", "落地页",
            "h5", "H5", "主页", "首页", "landing",
            # 个人/简历/作品类站点: 使「简历」详细需求 has_conv_req=True → 直冲生成器(不经 PM)
...
_CONTENT_KW = ("天气", "美食", "地图", "定位", "展示", "列表", "预约", "价格", "商品", "联系",
              ...
              "品牌", "风格", "配色", "主题",
              # 个人/简历站内容词: 使「简历」类详细需求 has_conv_req=True → 直冲生成器(不经 PM)
              "简历", "简介", "经历", "技能", "教育", "工作", "作品", "项目经验", "作品集")
