...
def setup_logging(service_name: str, *, level: int = logging.INFO) -> None:
    ...
    Args:
        service_name: 服务名,决定文件名前缀(如 "business" -> business.log)。
    ...
    # 按自然日滚动:每天午夜把当前 business.log 重命名为 business.log.YYYY-MM-DD,
    # 新文件继续写 business.log;backupCount=30 仅保留最近 30 天,避免无限膨胀。
