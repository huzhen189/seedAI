...
register_skill(name="agent_design", display_name="设计顾问", avatar="🎨", role="设计顾问", intent_tags=["设计","配色","布局","字体","动效","颜色","样式","主题","排版"], handler=design_agent_handler, is_graph=False, description="设计顾问: 配色/布局/字体/动效建议")
